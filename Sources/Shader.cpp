...
void Shader::CompileProgram()
{
    ...
    uniformDirectionalLight.ambientIntensity = glGetUniformLocation(
        shaderID, "directionalLight.base.ambientIntensity");
    uniformDirectionalLight.direction =
        glGetUniformLocation(shaderID, "directionalLight.direction");
    uniformDirectionalLight.diffuseIntensity = glGetUniformLocation(
        shaderID, "directionalLight.base.diffuseIntensity");
    ...
    for (size_t i = 0; i < MAX_POINT_LIGHTS; i++)
    {
        ...
        uniformPointLight[i].coefficient =
            glGetUniformLocation(shaderID, locBuff);
    }
    ...
    for (size_t i = 0; i < MAX_SPOT_LIGHTS; i++)
    {
        ...
        snprintf(locBuff, sizeof(locBuff), "spotLights[%d].base.coefficient",
                 i);
        uniformSpotLight[i].coefficient =
            glGetUniformLocation(shaderID, locBuff);
    ...
    uniformDirectionalLightTransform =
        glGetUniformLocation(shaderID, "directionalLightTransform");
    uniformTexture = glGetUniformLocation(shaderID, "theTexture");
    uniformDirectionalShadowMap =
        glGetUniformLocation(shaderID, "directionalShadowMap");
...
{
    light->UseLight(uniformDirectionalLight.ambientIntensity,
                    uniformDirectionalLight.color,
                            ...
                            unsigned int textureUnit, unsigned int offset)
{
    ...
    {
        light[i].UseLight(
            uniformPointLight[i].ambientIntensity, uniformPointLight[i].color,
            uniformPointLight[i].diffuseIntensity,
            uniformPointLight[i].position, uniformPointLight[i].constant,
            uniformPointLight[i].linear, uniformPointLight[i].coefficient);
                           ...
                           unsigned int textureUnit, unsigned int offset)
{
    ...
    {
        light[i].UseLight(
            uniformSpotLight[i].ambientIntensity, uniformSpotLight[i].color,
            uniformSpotLight[i].diffuseIntensity, uniformSpotLight[i].position,
            uniformSpotLight[i].direction, uniformSpotLight[i].constant,
            uniformSpotLight[i].linear, uniformSpotLight[i].coefficient,
